...
const BalanceCard = ({
	...
	return (
		<div className="flex flex-col gap-1 px-3 py-2 max-w-xs max-h-52 bg-white rounded-lg shadow-xl">
			<div className="flex justify-between items-center">
				<h1 className="text-[#878787] font-bold">{balanceName}</h1>
			...
			<div className="flex flex-col items-start  gap-2 ">
				<div className="flex flex-col items-start">
					<h1 className="text-[#191919] text-xl font-bold">{accountNumber}</h1>
					<p className="font-Inter text-sm text-[#9F9F9F]">Account Number</p>
				</div>
				<div className="flex flex-col items-start">
					<h1 className="text-[#191919] text-xl font-bold">${totalAmount}</h1>
